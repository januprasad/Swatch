package com.jenuine.materialpainter.view;
...
import com.jenuine.materialpainter.R;
...
public class PaletteView extends LinearLayout {
    ...
    public void showSwatchesView() {
        mutedSwatchView.getFlipper().showNext();
        mutedDarkSwatchView.getFlipper().showNext();
        mutedLightSwatchView.getFlipper().showNext();
        vibrantSwatchView.getFlipper().showNext();
        vibrantDarkSwatchView.getFlipper().showNext();
        vibrantLightSwatchView.getFlipper().showNext();
    }
